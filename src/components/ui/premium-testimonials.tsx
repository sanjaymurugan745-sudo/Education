...
const testimonials = [
  {
    ...
    rating: 5,
    text: "EduPortal transformed our entire training operation. We've seen a 300% increase in efficiency and saved countless hours in administrative tasks. The platform works flawlessly.",
    results: ["300% efficiency increase", "Cost savings", "24/7 access"]
  },
  {
    name: "Marcus Johnson",
    role: "Principal, DataDrive Academy",
    company: "DataDrive",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
    rating: 5,
    text: "The exam management system is revolutionary. Our student satisfaction increased by 40% while reducing grading time from hours to minutes. Incredible ROI.",
    results: ["40% satisfaction boost", "Instant grading", "Seamless integration"]
  },
  {
    name: "Elena Rodriguez",
    role: "VP Education, ScaleUp Co",
    company: "ScaleUp",
    avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face",
    rating: 5,
    text: "From course management to student tracking, EduPortal handles everything. Our team can finally focus on teaching instead of administrative tasks.",
  ...
  },
  {
    ...
    rating: 5,
    text: "The custom features delivered results beyond our expectations. Student engagement increased 150% while operational overhead decreased significantly.",
    results: ["150% engagement growth", "Reduced overhead", "Scalable systems"]
  },
  {
    name: "Lisa Thompson",
    ...
    rating: 5,
    text: "Exceptional platform that actually works. The implementation was smooth, and the results were immediate. Best investment we've made.",
      ...
      >
        ...
        >
          ...
          <motion.p 
            ...
            transition={{ duration: 0.8 }}
          >
            Join thousands of institutions already transforming their education systems with our platform.
          </motion.p>
        </motion.div>
